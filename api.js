...
8. 금액과 종목명을 절대 지어내지 마라. 아래 "경제 상황"과 "자산 변동"에 나온 숫자와 종목만 사용해라. "삼성전자", "포항제철", "현대" 같은 구체적 종목명을 쓰지 마라 — 아래 주식 보유 정보에 나온 이름만 써라 (코스피 또는 코스닥). 금액도 아래 제공된 숫자만 써라. 모르면 금액을 아예 쓰지 마라. 숫자를 나열하지 마라.
